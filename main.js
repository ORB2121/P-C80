...
function submit()
{
    ...
    for (var j = 1; j <= 4; j++)
    {
        var name_of_student_array = document.getElementById("name_of_the_student_"+j).val.console.log(name_of_student_array);
        name_of_student_array.push(name_of_student_array);
    }
